...
let activeReserveStorage = null;
let activeSearchStorage = null;
let activeSchemaId = null;
let activeSessionId = null;
let activeId = null;
let activeProviderId = null;
let activeCurrency = '';
let activeTotalCommission = 0;
let activeCommission = 0;
let activeTotal = 0;
if (flightReserveLocalStorage) {
    console.log('ddddddddddddddddddddd')
    activeReserveStorage = flightReserveLocalStorage;
    activeSearchStorage = flightSearchLocalStorage;
    activeSchemaId = activeSearchStorage.SchemaId;
    activeSessionId = activeSearchStorage.SessionId;
    activeCurrency = activeReserveStorage.PriceInfo?.Currency || '';
    activeTotalCommission = activeReserveStorage.PriceInfo?.TotalCommission || 0;
    activeCommission = activeReserveStorage.PriceInfo?.Commission || 0;
    activeTotal = activeReserveStorage.PriceInfo?.Total || 0;
    activeId = activeReserveStorage?.Provider?.ProviderId || null;
    activeProviderId = activeReserveStorage.Provider?.ProviderId || 0
}
/**
